...
export type GitHubStarsProps = {
  /** GitHub repository in `owner/repo` or full URL format. */
  repo: string
  /** Optional number of stars to display; if omitted, fetched from GitHub API. */
    ...
    <Tooltip>
      <TooltipTrigger asChild>
        <Button className="gap-1.5 pr-1.5 pl-2" variant="ghost" asChild>
          <a href={`https://github.com/${repoPath}`} target="_blank" rel="noopener">
